...
const signUpSchema = z.object({
  ...
  email: z.email("Agrega un correo electrónico valido"),
  password: z
  .string()
  .min(8,"La contraseña  debe tener al menor 8 caracteres"),
  confirmPassword: z.string().min(8,"La contraseña  debe tener al menor 8 caracteres"),
});
